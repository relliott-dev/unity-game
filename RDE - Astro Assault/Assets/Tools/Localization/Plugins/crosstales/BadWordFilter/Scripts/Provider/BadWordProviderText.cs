...
namespace Crosstales.BWF.Provider
{
   ...
   public class BadWordProviderText : BadWordProvider
   {
...
#endif
               {
                  System.Collections.Generic.List<string> list = Crosstales.BWF.Util.Helper2.SplitStringToLines(www.downloadHandler.text);
      ...
      private IEnumerator loadResource(Crosstales.BWF.Data.Source src)
      {
         ...
         {
            System.Collections.Generic.List<string> list = Crosstales.BWF.Util.Helper2.SplitStringToLines(src.Resource.text);
         ...
         if (!string.IsNullOrEmpty(src.URL))
         {
            try
            {
               ...
               using (System.Net.WebClient client = new Crosstales.Common.Util.CTWebClient())
               {
                  ...
                  System.Collections.Generic.List<string> list = Crosstales.BWF.Util.Helper2.SplitStringToLines(content);
